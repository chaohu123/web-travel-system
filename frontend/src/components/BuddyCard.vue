...
const props = withDefaults(
  ...
  { postId: undefined, teamId: undefined }
)
</script>
...
<template>
  <article class="bg-white rounded-2xl p-5 shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:border-indigo-100 transition-all">
    <div class="flex items-start gap-4">
      <div class="flex-shrink-0 w-14 h-14 rounded-full bg-gradient-to-br from-indigo-400 to-teal-400 flex items-center justify-center text-white text-lg font-bold overflow-hidden">
